...
namespace Microsoft.Azure.Commands.Network
{
    ...
    public class GetAzureFirewallPolicyRuleCollectionGroupDraftCommand : AzureFirewallPolicyRuleCollectionGroupBaseCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            {
                var azureFirewallPolicyRuleGroup = this.GetAzureFirewallPolicyRuleGroupDraft(AzureFirewallPolicy.ResourceGroupName, AzureFirewallPolicy.Name, this.Name);
                WriteObject(azureFirewallPolicyRuleGroup);
            }

            else if (this.IsParameterBound(c => c.AzureFirewallPolicyName))
            {
                var ruleGroup = this.GetAzureFirewallPolicyRuleGroupDraft(this.ResourceGroupName, AzureFirewallPolicyName, this.Name);
