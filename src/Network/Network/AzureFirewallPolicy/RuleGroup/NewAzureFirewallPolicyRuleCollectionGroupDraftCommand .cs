...
namespace Microsoft.Azure.Commands.Network
{
    ...
    public class NewAzureFirewallPolicyRuleCollectionGroupDraftCommand : AzureFirewallPolicyRuleCollectionGroupBaseCmdlet
    {
        ...
        public virtual string RuleCollectionGroupName { get; set; }
        ...
        public override void Execute()
        {
            ...
            {
                Name = this.RuleCollectionGroupName,
            ...
            this.AzureFirewallPolicyRuleGroupClient.CreateOrUpdateDraft(this.ResourceGroupName, this.FirewallPolicyName, this.RuleCollectionGroupName, deserializedruleGroup);
