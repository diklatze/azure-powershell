...
namespace Microsoft.Azure.Commands.Network
{
    ...
    public class RemoveAzureFirewallPolicyRuleGroupDraftCommand : AzureFirewallPolicyRuleCollectionGroupBaseCmdlet
    {
        ...
        public override void Execute()
        {
            ...
            ConfirmAction(
                ...
                () =>
                {
                    this.AzureFirewallPolicyRuleGroupClient.DeleteDraft(this.ResourceGroupName, this.AzureFirewallPolicyName, this.Name,null);
                    {
