...
namespace Microsoft.Azure.Commands.Network
{
    ...
    public class SetAzureFirewallPolicyRuleGroupDraftCommand : AzureFirewallPolicyRuleCollectionGroupBaseCmdlet
    {
        ...
        public override void Execute()
        {
            ...
            this.AzureFirewallPolicyRuleGroupClient.CreateOrUpdateDraft(this.ResourceGroupName, this.FirewallPolicyName, this.Name, deserializedruleGroup);
